...
public class Shirt2ThinModel extends WearableComponentModel {
    ...
    public void buildQuads(Matrix matrix, ImmutableList.Builder<BakedQuad> builder, VertexFormat format, TextureAtlasSprite sprite) {
        ...
        this.buildCuboidParented(this.bipedLeftArm, this.armLeft, 1.0F, 0.0F, -0.03F, 0.0F, matrix, builder, format, sprite);
        this.buildCuboidParented(this.bipedRightArm, this.armRight, 1.0F, 0.0F, -0.03F, 0.0F, matrix, builder, format, sprite);
    }
}
