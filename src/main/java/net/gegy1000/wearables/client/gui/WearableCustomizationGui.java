...
public class WearableCustomizationGui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawPropertyWidgets(x + 39, y + 62, mouseX, mouseY, ComponentProperty.OFFSET_Z);
        ...
        this.fontRenderer.drawString(I18n.translateToLocal("label.wearable_depth.name"), x + 6, y + 63, 0x404040);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        this.clickPropertyWidget(x + 39, y + 62, mouseX, mouseY, ComponentProperty.OFFSET_Z);
        if (mouseX >= x + 67 && mouseY >= y + 140 && mouseX <= x + 77 && mouseY <= y + 150) {
            this.rotation += 10.0F;
        }
        if (mouseX >= x + 129 && mouseY >= y + 140 && mouseX <= x + 140 && mouseY <= y + 150) {
